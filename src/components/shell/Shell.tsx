...
export function Shell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="bg-bg text-ivory min-h-screen font-body font-light max-w-[480px] mx-auto relative">
      {/* Top accent */}
      <div
        className="h-[2px]"
        style={{
      ...
      {/* Header */}
      <div className="sticky top-0 z-[100] bg-[rgba(6,13,22,0.97)] backdrop-blur-md border-b border-border px-3.5 py-2.5 flex items-center gap-2.5">
      ...
      {/* Bottom Nav */}
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] bg-[rgba(6,13,22,0.97)] backdrop-blur-md border-t border-border flex justify-around py-1.5 pb-[11px] z-[200]">
        {NAV.map((n) => {
